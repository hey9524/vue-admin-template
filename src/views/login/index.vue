  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on"
      ...
      <el-form-item prop="passwd">
        ...
        <el-input :key="passwdType" ref="passwd" v-model="loginForm.passwd" :type="passwdType" placeholder="密码"
          name="passwd" tabindex="2" auto-complete="on" @keyup.enter.native="handleLogin" />
        <span class="show-pwd" @click="showPwd">
          <svg-icon :icon-class="passwdType === 'password' ? 'eye' : 'eye-open'" />
        </span>
      </el-form-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      showPwd() {
        this.passwdType = this.passwdType === 'password' ? '' : 'password'
